...
export const CHAT_MODELS: ModelInfo[] = [
  ...
  // ─── OpenAI ───────────────────────────────────────────────────────────────
  {
    ...
    inputPrice: "$0.15",
    outputPrice: "$0.60",
    useCase: "Levná a rychlá alternativa k GPT-4o pro jednoduché úkoly",
    speed: 5,
    quality: 3,
    czech: 4,
  },
  {
    ...
    inputPrice: "$2.50",
    outputPrice: "$10",
    useCase: "Multimodální flagship — vision, kód, analýzy",
    speed: 4,
    quality: 4,
    czech: 4,
  },
  {
    ...
    inputPrice: "$10",
    outputPrice: "$30",
    useCase: "Nejaktuálnější GPT — nejlepší reasoning i kreativita",
    speed: 4,
    quality: 5,
    czech: 5,
  },
  {
    ...
    inputPrice: "$1.10",
    outputPrice: "$4.40",
    useCase: "Reasoning — STEM, logika, kód — přemýšlí před odpovědí",
    speed: 2,
    quality: 5,
    czech: 3,
  },
  {
    ...
    inputPrice: "$1.10",
    outputPrice: "$4.40",
    useCase: "Nejnovější reasoning model — lepší než o3-mini",
    speed: 2,
    quality: 5,
    czech: 3,
  },
